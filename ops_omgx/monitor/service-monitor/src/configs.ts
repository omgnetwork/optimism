...
export const l1WsUrl = process.env.L1_NODE_WEB3_WS
export const l2WsUrl = process.env.L2_NODE_WEB3_WS
...
export const mysqlHostUrl = process.env.MYSQL_HOST_URL
export const mysqlPort = parseInt(process.env.MYSQL_PORT, 10) || 3306
export const mysqlUsername = process.env.MYSQL_USERNAME
export const mysqlPassword = process.env.MYSQL_PASSWORD
export const mysqlDatabaseName = process.env.MYSQL_DATABASE_NAME

export enum OMGXNetwork {
  L1 = 'L1',
  L2 = 'L2',
}
