...
```bash
go get github.com/omgnetwork/optimism/ops_omgx/docker/vault/vault-unsealer
make -C $(go env GOPATH)/src/github.com/omgnetwork/optimism/ops_omgx/docker/vault/vault-unsealer build
```
