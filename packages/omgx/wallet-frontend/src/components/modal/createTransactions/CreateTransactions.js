    ...
    <>
      <Style>
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            <Box sx={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
              <Typography variant="h3" component="h3">To ETH  Mainnet</Typography>
              <NetworkSwitcherIcon active />
            </Box>
            <Typography variant="body1" component="span" sx={{opacity: 0.5}}>Select Token</Typography>
          </Grid>
      ...
      <SliderStyle>
        <Box sx={{display: 'flex', alignItems: 'center', gap: 1}}>
          ...
          <Typography variant="body1" component="p" sx={{fontSize: '16px'}}>It will take 7 days withdraw funds from OMGX</Typography>
        </Box>
        <Box sx={{display: 'flex', alignItems: 'center', gap: 1}}>
