...
import { ArrowBack, ArrowForward, Send } from '@material-ui/icons'
...
*/}
      {balances['oETH']['have'] && (
        <div className={styles.RabbitBox}>
          ...
          <div className={styles.RabbitRight}>
            <div className={styles.RabbitRightTop}>OMGX Balance</div>
            <div className={styles.RabbitRightMiddle}>
              <div className={styles.happy}>
                {balances['oETH']['amountShort']}
              </div>
            </div>
            <div className={styles.RabbitRightBottom}>oETH</div>
            <div className={styles.RabbitRightBottomNote}>
              {networkLayer === 'L1' && (
                <span>
                  You are on Mainnet (L1). Here, you can send tokens to OMGX. To
                  use the OMGX L2, please switch to L2 in MetaMask.
                </span>
              )}
              {networkLayer === 'L2' && (
                <span>
                  You are on OMGX (L2). Here, you can trade, transfer tokens to
                  others on OMGX, and send tokens to L1. To use L1, please
                  switch to L1 in MetaMask.
                </span>
              )}
            </div>
          </div>
      ...
      {!balances['oETH']['have'] && (
        <div className={styles.RabbitBox}>
          ...
          <div className={styles.RabbitRight}>
            <div className={styles.RabbitRightTop}>OMGX Balance</div>
            <div className={styles.RabbitRightMiddle}>0</div>
            <div className={styles.RabbitRightBottom}></div>
          </div>
        </div>
      )}
      ...
      <div className={styles.balances} style={{ marginTop: 30 }}>
        <div className={styles.boxWrapper}>
          <div className={styles.location}>
            <div>&nbsp;</div>
            {networkLayer === 'L1' && (
              <span className={styles.under}>You are on L1</span>
            )}
          ...
          <div
            className={[
              styles.box,
              networkLayer === 'L2' ? styles.dim : styles.active,
            ].join(' ')}
          >
        ...
        <div className={styles.boxWrapper}>
          <div className={styles.location}>
            ...
            {networkLayer === 'L2' && (
              <span className={styles.under}>You are on L2</span>
            )}
            <div>&nbsp;</div>
          </div>
          <div
            className={[
              styles.box,
              networkLayer === 'L1' ? styles.dim : styles.active,
            ].join(' ')}
          >
            <div className={styles.header}>
              <div className={styles.title}>
              ...
              <div
                ...
                className={[
                  styles.transfer,
                  networkLayer === 'L1' ? styles.disabled : '',
                ].join(' ')}
              >
                <Send />
                <span>TRANSFER</span>
