...
// Deployer account which owns the TEST token, among other things
export const deployerl1Wallet = new Wallet(process.env.DEPLOYER_PRIVATE_KEY,l1Provider)
export const deployerl2Wallet = deployerl1Wallet.connect(l2Provider)
