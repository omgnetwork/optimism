...
import { getAddressManager } from './shared/utils'
...
describe('Messenge Relayer Test', async () => {
  ...
  it('should deploy contracts', async () => {
    ...
    const addressManager = await getAddressManager(env.bobl1Wallet)
    const OVM_L1CrossDomainMessengerFastAddress = addressManager.getAddress('OVM_L1CrossDomainMessengerFast')
